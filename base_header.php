...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar ftco-navbar-light" id="ftco-navbar">
    <div class="container d-flex align-items-center">
      <img src="images/motherteresa_public_school_logo.png" style="height: 80px; padding: 5px" />
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item <?php echo ($page == "teacher" ? "active" : "")?>">
          ...
          <li class="nav-item <?php echo ($page == "more" ? "active" : "")?>">
            <a href="more.php" class="nav-link">More</a>
          </li>
        </ul>
      </div>
    </div>
